...
| https://camel.apache.org/manual/camel-4x-upgrade-guide-4_21.html#reifierstrategy[ReifierStrategy SPI Removed] | ⚠️ TODO-full | Needs removal recipe for `org.apache.camel.spi.ReifierStrategy`
...
| https://camel.apache.org/manual/camel-4x-upgrade-guide-4_21.html#camel-stomp-removal[camel-stomp Removed] | ⚠️ TODO-full | Needs `RemoveDependency` for `org.apache.camel:camel-stomp`
| https://camel.apache.org/manual/camel-4x-upgrade-guide-4_21.html#camel-aws-xray-removal[camel-aws-xray Removed] | ⚠️ TODO-full | Needs `RemoveDependency` for `org.apache.camel:camel-aws-xray`
| https://camel.apache.org/manual/camel-4x-upgrade-guide-4_21.html#camel-guava-eventbus-removal[camel-guava-eventbus Removed] | ⚠️ TODO-full | Needs `RemoveDependency` for `org.apache.camel:camel-guava-eventbus`
| https://camel.apache.org/manual/camel-4x-upgrade-guide-4_21.html#camel-grape-removal[camel-grape Removed] | ⚠️ TODO-full | Needs `RemoveDependency` for `org.apache.camel:camel-grape`
| https://camel.apache.org/manual/camel-4x-upgrade-guide-4_21.html#camel-elytron-removal[camel-elytron Removed] | ⚠️ TODO-full | Needs `RemoveDependency` for `org.apache.camel:camel-elytron`
...
| https://camel.apache.org/manual/camel-4x-upgrade-guide-4_21.html#camel-djl[camel-djl Word Embedding Removed] | ⚠️ TODO-partial | Needs removal of `ZooWordEmbeddingPredictor`
...
| https://camel.apache.org/manual/camel-4x-upgrade-guide-4_21.html#camel-jooq-dbcp[camel-jooq DBCP Dependency] | ⚠️ TODO-full | Needs `ChangeDependency`: `commons-dbcp:commons-dbcp` → `org.apache.commons:commons-dbcp2`
