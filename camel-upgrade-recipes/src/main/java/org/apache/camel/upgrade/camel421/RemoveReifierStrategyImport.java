...
public class RemoveReifierStrategyImport extends Recipe {

    @Override
    public String getDisplayName() {
        return "Remove ReifierStrategy import";
    }

    @Override
    public String getDescription() {
        return "Removes import for org.apache.camel.spi.ReifierStrategy which is no longer in use.";
    }
