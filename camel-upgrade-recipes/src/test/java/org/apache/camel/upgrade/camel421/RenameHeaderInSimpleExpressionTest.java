...
public class RenameHeaderInSimpleExpressionTest implements RewriteTest {
    ...
    @DocumentExample
    @Test
    void testSimpleExpressionHeaderMigration() {
        //language=java
        rewriteRun(
            java(
                """
    ...
    @Test
    void testSimpleExpressionHeadersVariantMigration() {
        //language=java
        rewriteRun(
            java(
                """
    ...
    @Test
    void testSimpleExpressionInSetHeader() {
        //language=java
        rewriteRun(
            java(
                """
    ...
    @Test
    void testSimpleExpressionWithOtherText() {
        //language=java
        rewriteRun(
            java(
                """
    ...
    @Test
    void testMultipleSimpleExpressions() {
        //language=java
        rewriteRun(
            java(
                """
    ...
    @Test
    void testDoesNotMigrateNonSimpleStrings() {
        //language=java
        rewriteRun(
            java(
                """
    ...
    @Test
    void testDoesNotMigrateDifferentHeader() {
        //language=java
        rewriteRun(
            java(
                """
    ...
    @Test
    void testDoesNotMigratePartialMatch() {
        //language=java
        rewriteRun(
            java(
                """
