...
public class RenameHeaderInYamlDslTest implements RewriteTest {
    ...
    @Test
    void testHeaderPredicateMigration() {
        //language=yaml
        rewriteRun(
            yaml(
                """
    ...
    @Test
    void testRemoveHeaderMigration() {
        //language=yaml
        rewriteRun(
            yaml(
                """
    ...
    @Test
    void testSetHeaderWithSimpleExpression() {
        //language=yaml
        rewriteRun(
            yaml(
                """
    ...
    @Test
    void testDoesNotMigrateNonHeaderName() {
        //language=yaml
        rewriteRun(
            yaml(
                """
    ...
    @Test
    void testDoesNotMigrateNonCamelYaml() {
        //language=yaml
        rewriteRun(
            yaml(
                """
