...
public class RenameHeaderPrefixInSimpleExpressionTest implements RewriteTest {
    ...
    @DocumentExample
    @Test
    void testSimpleExpressionHeaderPrefixMigration() {
        //language=java
        rewriteRun(
            java(
                """
    ...
    @Test
    void testSimpleExpressionHeadersVariantPrefixMigration() {
        //language=java
        rewriteRun(
            java(
                """
    ...
    @Test
    void testMultipleHeaderReferencesInOneExpression() {
        //language=java
        rewriteRun(
            java(
                """
    ...
    @Test
    void testDoesNotMigrateOutsideSimpleMethod() {
        //language=java
        rewriteRun(
            java(
                """
