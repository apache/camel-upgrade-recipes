...
class CamelUpdate47Test implements RewriteTest {
     ...
     */
    @Test
    void xmlDslLoadBalanceRandomKeep() {
        //language=xml
        rewriteRun(xml(
                """
                <random/>
